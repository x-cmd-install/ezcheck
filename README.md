...
[![x-cmd/install — ezcheck Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/ezcheck.svg)](https://x-cmd.com/install/ezcheck)
...
Total: **1,764** lines of code across **14** files in the top 5 languages.
...
- **Upstream**: <https://github.com/Metaphorme/ezcheck>
- **Homepage**: <https://crates.io/crates/ezcheck>
- **License**: MIT

## Release

- **Latest**: `0.1.7` (2025-02-23)
- **Last commit**: 2026-09-04
- **Assets in release**: 14

## Popularity

- **Stars**: 24 · **Forks**: 1 · **Open issues**: 3 · **Contributors**: 1
...
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-26 | 0 | 0 | 3 | 0 | 0 | 8 |
| last60d | 2026-07-27 | 0 | 0 | 3 | 0 | 0 | 8 |
| 90d | 2026-06-27 | 0 | 0 | 4 | 0 | 0 | 8 |
| last180d | 2026-03-29 | 0 | 2 | 5 | 0 | 0 | 15 |
| 360d | 2025-09-30 | 0 | 6 | 5 | 0 | 0 | 19 |
| last720d | 2024-10-05 | 7 | 27 | 5 | 2 | 1 | 139 |
...
Install metadata for ezcheck lives in the [x-cmd/install](https://github.com/x-cmd/install) index — a curated YAML package list that x-cmd consumes at install time. If `ezcheck` is missing, out of date, or installs incorrectly, please open an issue or PR there:

- **Open an issue**: <https://github.com/x-cmd/install/issues/new>
- **Edit the package entry**: <https://github.com/x-cmd/install/edit/main/ezcheck.yml> (or whichever path the index uses)

The data on this page (card / loc / scorecard / release) is auto-collected by [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) and is regenerated daily. Improvements to *install behaviour* (which version gets installed, platform-specific quirks, dependencies) belong upstream in the index.

_Snapshot: `data/card/260925.yml` · 2026-09-25T05:32:55Z._
